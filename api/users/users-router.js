...
const { checkUserExists, checkUserPayload, checkUserModifiedPayload } = require('../middlewares/user-middlewares')
...
router.put('/:id', checkUserExists, checkUserModifiedPayload, (req, res, next) => {
    userModel.modify(req.params.id, req.body)
    .then(updatedUser => {
